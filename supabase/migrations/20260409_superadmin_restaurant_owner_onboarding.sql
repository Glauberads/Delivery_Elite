...
BEGIN
    ...
    ELSE
        ...
        SET
            plan_id = p_plan_id,
            status = CASE WHEN p_status = 'trial' THEN 'trialing'::public.subscription_status ELSE 'active'::public.subscription_status END,
            updated_at = now()
        WHERE tenant_id = v_tenant_id;
        ...
        IF NOT FOUND THEN
            INSERT INTO public.tenant_subscriptions (
                ...
                v_tenant_id,
                p_plan_id,
                CASE WHEN p_status = 'trial' THEN 'trialing'::public.subscription_status ELSE 'active'::public.subscription_status END
            );
        END IF;
    END IF;
