-- Migration: Fix get_product_full to return only selected items per product
-- Date: 2026-04-16
-- Scope: Read contract only (PDV/Home/Modal)
...
BEGIN
    ...
    RETURN QUERY
    SELECT *
    FROM public.get_product_full(v_tenant_id) pf
